...
) : UseCase<GetLastSeenUseCase.Params, List<Product>>(), GetLastSeenUseCase {

    override suspend fun doWork(params: GetLastSeenUseCase.Params): ResultStatus<List<Product>> {
